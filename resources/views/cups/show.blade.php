...
@section('pagetitle', 'Cup ' . $thing->name . ' '.$year)
@section('content')
    @php
                    ...
                    @if (array_key_exists($category->id, $winners_by_category) && count($winners_by_category[$category->id]) > 0)
                        <td>
                            @if (array_key_exists('1', $winners_by_category[$category->id]))
                                {{$winners[$winners_by_category[$category->id]['1']['entrant']]->getName($printableNames)}}
                        ...
                        <td>
                            @if (array_key_exists('2', $winners_by_category[$category->id]))
                                {{$winners[$winners_by_category[$category->id]['2']['entrant']]->getName($printableNames)}}
                        ...
                        <td>
                            @if (array_key_exists('3', $winners_by_category[$category->id]))
                                {{$winners[$winners_by_category[$category->id]['3']['entrant']]->getName($printableNames)}}
                        ...
                        <td>
                            @if (array_key_exists('commended', $winners_by_category[$category->id]))
                                {{$winners[$winners_by_category[$category->id]['commended']['entrant']]->getName($printableNames)}}
