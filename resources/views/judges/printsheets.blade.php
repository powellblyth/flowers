...
<div id="everything">
    ...
    @endphp
        ...
        <div><big>Please enter the entrant number <b>only</b> in the relevant boxes. Commendations are optional but welcome especially in the junior categoeries
            <br />
    ...
    @foreach ($judge->relatedCategories($show) as $category)
        ...
        <tr>
            ...
            <td><div class="result">&nbsp;</div></td>
            <td><div class="result">&nbsp;</div></td>
            <td><div class="result_commended">&nbsp;</div></td>
        </tr>
        @endforeach
    </table>
