    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                <a class="btn btn-default btn-xl js-scroll-trigger" href="{{route('family')}}">&lt; @lang('Go back')</a>
                @if($entrant->exists)
                    <form method="POST" action="{{route('entrants.update', ['entrant'=>$entrant])}}">
                        @method('PUT')
                @else
                ...
                @endif
                    ...
                    <div class="py-4">
                        ...
                        <x-select name="team_id" class="px-4 py-3 rounded-full" hasBlank="true"
                        :options="$teams"></x-select>
                    </div>
                    <div class="py-4">
